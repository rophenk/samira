@extends('tnde.master')
@section('title', 'Berkas Kompilasi' )
...
@section('breadcrumb')
                        ...
                        <li>
                            <a href="#" class="active">Berkas Kompilasi</a>
                        </li>
@endsection
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="portlet light bordered">
                                            <div class="portlet-title">
                                                <div class="caption font-green-haze">
                                                    ...
                                                    <span class="caption-subject bold uppercase"> Berkas Kompilasi</span>
                                                </div>
                                                <div class="actions">
                                            ...
                                            <div class="portlet-body">
                                                <div class="tabbable-line">
                                                    <ul class="nav nav-tabs ">
                                                        <li class="active">
                                                            <a href="#tab_15_1" data-toggle="tab"> Unggah Berkas Kompilasi</a>
                                                        </li>
                                                        <li>
                                                            <a href="#tab_15_2" data-toggle="tab"> Lihat Berkas Kompilasi</a>
                                                        </li>
                                                        <!--<li>
                                                    ...
                                                    <div class="tab-content">
                                                        <div class="tab-pane active" id="tab_15_1">
                                                            <form id="upload" action="/attachment-incoming/1" enctype="multipart/form-data" class="form-horizontal">
                                          <div class="form-body">
                                        ...
                                        <div class="panel panel-success">
                                            <div class="panel-heading">
                                                <h3 class="panel-title">Catatan Upload Berkas Kompilasi</h3>
                                            </div>
                                            <div class="panel-body">
                                                <ul>
                                                    ...
                                                    <li> Hanya menerima file dengan extension (
                                                        <strong>JPG, GIF, PNG, PDF, DOC, DOCX, PPT, PPTX</strong>)  </li>
                                                        ...
                                                        <div class="tab-pane" id="tab_15_2">
                                                            ...
                                                            <p>
                                                              <div id="list"> 
                                                              <ul>
                                                                <li><a href="/attachment-show-incoming/1"></a>&nbsp; <a href="/attachment-incoming-delete/1"><span class="label label-sm label-danger"> <i class="fa fa-times"></i> Hapus </span></a></li>
 ...
 <script src="../assets/global/plugins/fancybox/source/jquery.fancybox.pack.js" type="text/javascript"></script>
        ...
        <script type="text/javascript">
          ...
          form.addEventListener('submit', function(e){
            ...
            request.open('post', '/attachment-incoming/1');
          ...
          function transferComplete(data) {
            ...
            if(response.success){
              ...
              $('#list').load('/attachment-incoming-list/1');
            }
          }
        </script>

                        ...
                        <div class="nav-collapse collapse navbar-collapse navbar-responsive-collapse">
                            <ul class="nav navbar-nav">
                                <li class="dropdown dropdown-fw<?php echo $dashboard; ?>">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-fw">
                                        <li class="dropdown more-dropdown-sub">
                                            <a href="javascript:;">Data Penyuluhan</a>
                                            <ul class="dropdown-menu">
                                                <li class="dropdown more-dropdown-sub">
                                                    <a href="javascript:;"> Statis </a>
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                ...
                                                <li class="dropdown more-dropdown-sub">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            <a href="#"> Kelompok Pemuda Tani </a>
                                                        </li>
                                                        <li>
                                                            <a href="#"> Kelompok Wanita Tani </a>
                                                        </li>
                                                        <li>
                                                            <a href="#"> Kelompok Tani Penerima Alsintan </a>
                                                        </li>
                                                        <li class="dropdown more-dropdown-sub">
                                                            <a href="#"> Produktivitas </a>
                                                            <ul class="dropdown-menu">
                                                                <li>
                                                                    <a href="#"> Luas Tanam </a>
                                                                </li>
                                                                ...
                                                                <li>
                                                                    <a href="#"> Tambah Tanam </a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                        <li>
                                                            <a href="#"> Kelompok Tani Potensi Komoditas Pertanian Strategis </a>
                                                        </li>
                                                        <li>
                                                            <a href="#"> Serapan Gabah  </a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li class="divider"></li>
                                        ...
                                        <li>
                                            <a href="#">Data Sekretariat</a>
                                        </li>
                                        <li>
                                            <a href="#">Program Aksi</a>
                                        </li>
                                        <li>
                                            <a href="#">Link Ke Web</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="dropdown dropdown-fw  ">
                                    <a href="javascript:;" class="text-uppercase">
                                        <i class="icon-camera"></i> MATRIK </a>
                                    <ul class="dropdown-menu dropdown-menu-fw">
                                        <li class="dropdown more-dropdown-sub">
                                            <a href="javascript:;">

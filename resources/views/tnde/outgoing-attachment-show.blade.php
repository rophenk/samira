...
@section('content')
<a href="../tnde/{{ $attachment->outgoing_uuid }}/{{ $attachment->name }}"><button class="btn blue">Unduh Berkas</button></a><br />
<a class="media" href="../tnde/{{ $attachment->outgoing_uuid }}/{{ $attachment->name }}">Unduh Berkas</a>
@endsection

...
@section('breadcrumb')
                        ...
                        <li>
                            <a href="#" class="active">Foto Pengguna</a>
                        </li>
@endsection
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="portlet light bordered">
                                            <div class="portlet-title">
                                                <div class="caption font-green-haze">
                                                    ...
                                                    <span class="caption-subject bold uppercase"> Foto Pengguna</span>
                                                </div>
                                                <div class="actions">
                                            ...
                                            <div class="portlet-body">
                                                <div class="tabbable-line">
                                                    <ul class="nav nav-tabs ">
                                                        <li class="active">
                                                            <a href="#tab_15_1" data-toggle="tab"> Unggah Foto</a>
                                                        </li>
                                                        <li>
                                                            <a href="#tab_15_2" data-toggle="tab"> Lihat Foto</a>
                                                        </li>
                                                        <!--<li>
                                                    ...
                                                    <div class="tab-content">
                                                        <div class="tab-pane active" id="tab_15_1">
                                                            <form id="upload" method="post" action="/avatar-users" enctype="multipart/form-data" class="form-horizontal">
                                          <div class="form-body">
                                            
                                            <div class="form-group form-md-line-input">
                                                            <label class="col-md-2 control-label" for="form_control_1">Berkas Foto</label>
                                                            <div class="col-md-10">
                                        ...
                                        <div class="panel panel-success">
                                            <div class="panel-heading">
                                                <h3 class="panel-title">Catatan Upload Foto Pengguna</h3>
                                            </div>
                                            <div class="panel-body">
                                                <ul>
                                                    <li> Ukuran Maksimum File
                                                        <strong>150 kB</strong> </li>
                                                    <li> Hanya menerima file dengan extension (
                                                        <strong>JPG, GIF, PNG</strong>)  </li>
                                                            ...
                                                            <p>
                                                              ...
                                                              <ul>
                                                                ...
                                                                <div class="mt-comment-img">
                                                                    <img src="{{ $userdb->avatar }}" height="50px"/> 
                                                                </div>
                                                                </p>
                                                                <!--<a href="/attachment-show-incoming/{{ $userdb->id }}">{{ $userdb->avatar }}</a>&nbsp; -->
                                                                </li>
                                                              </ul>
                                                              </div>
                                                            </p>
 ...
 <script src="../assets/global/plugins/fancybox/source/jquery.fancybox.pack.js" type="text/javascript"></script>
        ...
        <script type="text/javascript">
          ...
          form.addEventListener('submit', function(e){
            ...
            request.open('post', '/avatar-users');
          ...
          function transferComplete(data) {
            ...
            if(response.success){
              document.getElementById('message').innerHTML = "Berkas Foto Berhasil Diunggah";
              $('#list').load('/avatar-users-list/{{ $userdb->id }}');
            }
          }
        </script>

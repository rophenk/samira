...
@section('breadcrumb')
                        ...
                        <li>
                            <a href="/home" class="active">Edit Surat Masuk</a>
                        </li>
@endsection
...
<!-- BEGIN SIDEBAR CONTENT LAYOUT -->
                    ...
                    <?php
                    $explode_input_date = explode("-",$incoming->input_date);
                    $input_date = $explode_input_date[2]."-".$explode_input_date[1]."-".$explode_input_date[0]; 
                    
                    $explode_letter_date = explode("-",$incoming->letter_date);
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="portlet light bordered">
                                            ...
                                            <div class="portlet-body form">
                                                <form role="form" class="form-horizontal" action="/edit-incoming" method="post">
                                                    <div class="form-body">
                                                        ...
                                                        <div class="form-group form-md-line-input">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input type="text" name="agenda_number" class="form-control" id="form_control_1" placeholder="Nomor Agenda" value="{{ $incoming->agenda_number }}">
                                                                <div class="form-control-focus"> </div>
                                                        ...
                                                        <div class="form-group form-md-line-input">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input type="text" name="letter_number" class="form-control" id="form_control_1" placeholder="Nomor Surat" value="{{ $incoming->letter_number }}">
                                                                <div class="form-control-focus"> </div>
                                                                <span class="help-block">Some help goes here...</span>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group form-md-line-input">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input type="text" name="sender" class="form-control" id="form_control_1" placeholder="Nama / Institusi Pengirim" value="{{ $incoming->sender }}">
                                                                <div class="form-control-focus"> </div>
                                                                <span class="help-block">Some help goes here...</span>
                                                            </div>
                                                        </div>
                                                        <div class="form-group form-md-line-input">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input type="text" name="receiver" class="form-control" id="form_control_1" placeholder="Nama / Institusi Tujuan" value="{{ $incoming->receiver }}">
                                                                <div class="form-control-focus"> </div>
                                                                <span class="help-block">Some help goes here...</span>
                                                            </div>
                                                        </div>

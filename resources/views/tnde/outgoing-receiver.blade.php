@extends('tnde.master')
@section('title', 'Penerima Surat Keluar' )
...
@section('breadcrumb')
                        ...
                        <li>
                            <a href="#" class="active">Penerima Surat Keluar</a>
                        </li>
@endsection
                                ...
                                <!-- END PAGE BASE CONTENT -->
                                                ...
                                                <div class="modal fade bs-modal-lg" id="large" tabindex="-1" role="dialog" aria-hidden="true">
                                                    <div class="modal-dialog modal-lg">
                                                        <form role="form" class="form-horizontal" action="/receiver-outgoing" method="post">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body"> 
                                                                    ...
                                                                    <input type="hidden" name="outgoing_uuid" value="{{ $outgoing->uuid }}" />
                                                                </div>

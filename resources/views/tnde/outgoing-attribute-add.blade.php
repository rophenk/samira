@extends('tnde.master')
@section('title', 'Attribute Surat Keluar' )
...
@section('breadcrumb')
                        ...
                        <li>
                            <a href="#" class="active">Attribute Surat Keluar</a>
                        </li>
@endsection
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="portlet light bordered">
                                            ...
                                            <div class="portlet-body form">
                                              ...
                                              if($outgoing->letter_type == "Surat Biasa Masuk") {$sbm = ' selected="yes"';}
                                              elseif($outgoing->letter_type == "Nota Dinas") {$nd = ' selected="yes"';}
                                              elseif($outgoing->letter_type == "Internal Memo") {$im = ' selected="yes"';}
                                              elseif($outgoing->letter_type == "Surat Telegram") {$st = ' selected="yes"';}

                                              if($outgoing->letter_classification == "Bebas") {$bbs = ' selected="yes"';}
                                              elseif($outgoing->letter_classification == "Rahasia") {$rhs = ' selected="yes"';}

                                              if($outgoing->letter_character == "Biasa") {$bsa = ' selected="yes"';}
                                              elseif($outgoing->letter_character == "Kilat") {$klt = ' selected="yes"';}

                                              if($outgoing->letter_expedition == "Departemen") {$dpt = ' selected="yes"';}
                                              elseif($outgoing->letter_expedition == "Faximile") {$fax = ' selected="yes"';}
                                              elseif($outgoing->letter_expedition == "Langsung") {$lsg = ' selected="yes"';}
                                              elseif($outgoing->letter_expedition == "Paket") {$pkt = ' selected="yes"';}
                                              elseif($outgoing->letter_expedition == "Pos") {$pos = ' selected="yes"';}

                                              if($outgoing->letter_storage == "Rak 01") {$rk1 = ' selected="yes"';}
                                              elseif($outgoing->letter_storage == "Rak 02") {$rk2 = ' selected="yes"';}
                                              elseif($outgoing->letter_storage == "Rak 03") {$rk3 = ' selected="yes"';}
                                              elseif($outgoing->letter_storage == "Rak 04") {$rk4 = ' selected="yes"';}
                                              elseif($outgoing->letter_storage == "Rak 05") {$rk5 = ' selected="yes"';}
                                              
                                              ?>
                                                <form role="form" class="form-horizontal" action="/attribute-outgoing" method="post">
                                                    <div class="form-body">

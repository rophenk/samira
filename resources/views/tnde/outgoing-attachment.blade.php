@extends('tnde.master')
@section('title', 'Lampiran Surat Keluar' )
...
@section('breadcrumb')
                        ...
                        <li>
                            <a href="#" class="active">Lampiran Surat Keluar</a>
                        </li>
@endsection
                                                ...
                                                <div class="tabbable-line">
                                                    ...
                                                    <div class="tab-content">
                                                        <div class="tab-pane active" id="tab_15_1">
                                                            <form id="upload" action="/attachment-outgoing/{{ $outgoing->uuid }}" enctype="multipart/form-data" class="form-horizontal">
                                          <div class="form-body">
 ...
 <script src="../assets/global/plugins/fancybox/source/jquery.fancybox.pack.js" type="text/javascript"></script>
        ...
        <script type="text/javascript">
          ...
          form.addEventListener('submit', function(e){
            ...
            request.open('post', '/attachment-outgoing/{{ $outgoing->uuid }}');

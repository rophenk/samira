...
@section('breadcrumb')
                        ...
                        <li>
                            <a href="#" class="active">Tambah Kegiatan</a>
                        </li>
@endsection
                                            ...
                                            <div class="portlet-body form">
                                                <form role="form" class="form-horizontal" action="#" method="post">
                                                    <div class="form-body">
                                                        ...
                                                        ?>
                                                        <div class="form-group form-md-line-input">
                                                            <label class="control-label col-md-2" for="form_control_1">Tanggal Kegiatan</label>
                                                            <div class="col-md-2">
                                                        ...
                                                        <div class="form-group form-md-line-input">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input type="text" name="agenda_number" class="form-control" id="form_control_1" placeholder="Nama Kegiatan">
                                                                <div class="form-control-focus"> </div>
                                                        ...
                                                        <div class="form-group form-md-line-input">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input type="text" name="letter_number" class="form-control" id="form_control_1" placeholder="Tempat Kegiatan">
                                                                <div class="form-control-focus"> </div>
                                                                <span class="help-block">Some help goes here...</span>
                                                            </div>
                                                        </div>

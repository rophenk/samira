...
@section('breadcrumb')
                        ...
                        <li>
                            <a href="/home" class="active">Data Surat Keluar</a>
                        </li>
@endsection
                                        ...
                                        <div class="portlet light bordered">
                                            <div class="portlet-title">
                                                <div class="caption font-dark">
                                                    ...
                                                    <span class="caption-subject bold uppercase"> Daftar Surat Keluar</span>
                                                </div>
                                                <!--<div class="actions">
                                            ...
                                            <div class="portlet-body">
                                                ...
                                                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                                    ...
                                                    <tbody>
                                                      ...
                                                      <tr class="odd gradeX">
                                                            <td width="25%" class="left"> {{ $outgoing->agenda_number }} </td>
                                                            <td>
                                                              {{ $outgoing->sender }}<br />
                                                                <a href="/edit-outgoing/{{ $outgoing->uuid }}">  {{ $outgoing->subject }} </a>
                                                            </td>
                                                            <td>
                                                                <span class="label label-sm label-success"> Approved </span>
                                                            </td>
                                                            <td class="center"> {{ $outgoing->letter_date }} </td>
                                                            <td>
                                                                <div class="btn-group">
                                                                    ...
                                                                    <ul class="dropdown-menu" role="menu">
                                                                        <li>
                                                                            <a href="/edit-outgoing/{{ $outgoing->uuid }}">

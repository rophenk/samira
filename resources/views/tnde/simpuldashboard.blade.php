                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption caption-md">
                                        ...
                                        <span class="caption-subject font-dark bold uppercase">Aktivitas Satker</span>
                                        <span class="caption-helper">status mingguan...</span>
                                    </div>
                                    <div class="actions">
                                        <div class="btn-group btn-group-devided" data-toggle="buttons">
                                            <label class="btn btn-transparent green btn-outline btn-circle btn-sm active">
                                                <input type="radio" name="options" class="toggle" id="option1">Harian</label>
                                            <label class="btn btn-transparent green btn-outline btn-circle btn-sm">
                                                <input type="radio" name="options" class="toggle" id="option2">Mingguan</label>
                                            <label class="btn btn-transparent green btn-outline btn-circle btn-sm">
                                                <input type="radio" name="options" class="toggle" id="option2">Bulanan</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="portlet-body">
                                    ...
                                    <div class="table-scrollable table-scrollable-borderless">
                                        <table class="table table-hover table-light">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="javascript:;" class="primary-link">BBPADI</a>
                                                </td>
                                                <td> 345 Jt</td>
                                                <td> 45 Jt</td>
                                                <td> 300 Jt</td>
                                                <td>
                                                    <span class="bold theme-font">13%</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="fit">
                                                ...
                                                <td>
                                                    <a href="javascript:;" class="primary-link">BET</a>
                                                </td>
                                                <td> 560 Jt</td>
                                                <td> 125 Jt</td>
                                                <td> 435 Jt</td>
                                                <td>
                                                    <span class="bold theme-font">22%</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="fit">
                                                ...
                                                <td>
                                                    <a href="javascript:;" class="primary-link">PUSDATIN</a>
                                                </td>
                                                <td> 640 Jt</td>
                                                <td> 450 Jt</td>
                                                <td> 190 Jt</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="javascript:;" class="primary-link">BP2TP</a>
                                                </td>
                                                <td> 315 Jt </td>
                                                <td> 112 Jt</td>
                                                <td> 203 Jt</td>
                                                <td>
                                                    <span class="bold theme-font">55%</span>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>

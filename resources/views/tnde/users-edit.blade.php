...
@section('breadcrumb')
                        ...
                        <li>
                            <a href="#" class="active">Edit Pengguna</a>
                        </li>
@endsection
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="portlet light bordered">
                                            ...
                                            <div class="portlet-body form">
                                                <form role="form" class="form-horizontal" action="/edit-users" method="post">
                                                    <div class="form-body">
                                                        ...
                                                        <div class="form-group form-md-line-input">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input type="text" name="name" class="form-control" id="form_control_1" placeholder="Nama Lengkap" value="{{ $userdb->name }}">
                                                                <div class="form-control-focus"> </div>
                                                        ...
                                                        <div class="form-group form-md-line-input">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input type="text" name="email" class="form-control" id="form_control_1" placeholder="Email Pengguna" value="{{ $userdb->email }}">
                                                                <div class="form-control-focus"> </div>
                                                                ...
                                                                <div class="col-md-10">
                                                                    ...
                                                                    <select id="internal" name="workUnitsID" class="form-control select2-multiple">
                                                                        @forelse ($satker as $workunit)
                                                                            <option value="{{ $workunit->id }}" @if($userdb->workUnitsID === $workunit->id) selected="yes" @endif >{{ $workunit->name }}</option>
                                                                        @empty
                                                                        @endforelse
                                                                    </select>
                                                                </div>
                                                        ...
                                                        <div class="form-group form-md-line-input">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input type="text" name="phone" class="form-control" id="form_control_1" placeholder="Nomor Telepon" value="{{ $userdb->phone }}">
                                                                <div class="form-control-focus"> </div>
                                                        ...
                                                        <div class="form-group form-md-line-input has-success">
                                                            ...
                                                            <div class="col-md-10">
                                                                <textarea class="wysihtml5 form-control" name="address" rows="6">{{ $userdb->address }}</textarea>
                                                            </div>
                                                        </div>
                                                        <div id="roles">    
                                                            <div class="form-group form-md-line-input">
                                                                ...
                                                                <div class="col-md-10">
                                                                    ...
                                                                    <select id="internal" name="role_id" class="form-control select2-multiple">
                                                                        @forelse ($roles as $role)
                                                                            <option value="{{ $role->id }}" @if($userdb->role_id === $role->id) selected="yes" @endif >{{ $role->name }}</option>
                                                                        @empty
                                                                        @endforelse
                                                                    </select>
                                                                </div>
                                                        ...
                                                        <div class="form-group form-md-line-input">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input type="password" name="new    password" class="form-control" id="form_control_1" placeholder="Isi jika ingin mengubah password, kosongkan jika tidak mengubah password">
                                                                <div class="form-control-focus"> </div>
